        ...
        class ArticlesController < ApplicationController
            ...
            def create
                ...
                if article.save
                    ...
                    render json: {status: 'ERROR', message: 'Article is not saved', data: article.errors}, status: :unprocessable_entity
                end
            end
            ...
            def update
                ...
                if article.update_attributes(article_params)
                    ...
                    render json: {status: 'ERROR', message: 'Article is not updated', data: article.errors}, status: :unprocessable_entity
                end
            end
